...
public class Order implements Serializable {
  ...
  public void finalizeOrder() throws InvalidInputException {
    if (isFinalized) {
      throw new InvalidInputException("Order has already been finalized.");
    }
  ...
  public String toString() {
    return String.format(
      "Order ID: %-6s | Customer: %-20s | Date: %s | Total: %.2f VND",
      orderId,
      customer.getName(),
      orderDate,
      totalAmount
